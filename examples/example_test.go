...
// Runnable examples for the collection package.
//
// Every function whose name starts with Example is compiled and executed by
// `go test`, verifying the // Output: comment.  They also appear verbatim on
// pkg.go.dev as interactive code samples.
